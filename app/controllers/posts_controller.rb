class PostsController < ApplicationController
	...
	private
	def post_params
		params.require(:post).permit(:title, :status  , :image , checkin_attributes: [:address , :lat , :long])
	end

	def post_update_params
		params.require(:post).permit(:title, :status  , :image , :photo_id , checkin_attributes: [:address , :lat , :long])
	end
end
